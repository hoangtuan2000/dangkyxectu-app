          ...
          <ScrollView
            ...
            <View>
              <Text
                ...
                {Strings.RentedCarFilterModal.TITLE}
              </Text>

              {/* SCHEDULE_CODE */}
              <InputCustom
                label={Strings.RentedCarFilterModal.SCHEDULE_CODE}
                styleLabel={{fontSize: Constants.Styles.FontSize.LARGE}}
                placeholder={Strings.RentedCarFilterModal.ENTER_SCHEDULE_CODE}
                style={{fontSize: 16}}
              ...
              <MultiSelectBox
                ...
                label={Strings.RentedCarFilterModal.STATUS}
                inputPlaceholder={Strings.RentedCarFilterModal.CHOOSE_STATUS}
              ...
              <MultiSelectBox
                data={carTypeList}
                label={Strings.RentedCarFilterModal.CAR_TYPE}
                inputPlaceholder={Strings.RentedCarFilterModal.CHOOSE_CAR_TYPE}
              ...
              <ButtonAddress
                ...
                label={Strings.RentedCarFilterModal.ADDRESS}
                address={showAddress}
                placeholder={Strings.RentedCarFilterModal.CHOOSE_ADDRESS}
              />
...
export default RentedCarFilterModal;
